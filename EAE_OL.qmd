...
Slc16a1Plot = ggplot(Slc16a1_exp, aes(x = stim,
           ...
           #     scale_color_discrete('Sample',type = colsDots) + 
              #  xlab('Slc16a1/MCT1 expression in Oligodendrocytes (Meijer et al. 2022)') + 
                ...
                VlnPlotTheme 
Slc16a1Plot
ggsave('Slc16a1_Meijer2022.png',plot = Slc16a1Plot, dpi = 600,width = 6,height = 5,units = 'cm')
ggsave('Slc16a1_Meijer2022.svg',plot = Slc16a1Plot, dpi = 600,width = 6,height = 5,units = 'cm')
